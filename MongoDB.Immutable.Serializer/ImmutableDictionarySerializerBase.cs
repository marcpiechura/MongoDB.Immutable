...
namespace MongoDB.Immutable.Serializer
{
    ...
    */
        ...
        where TDictionary : class, IImmutableDictionary<TKey, TValue>
    {
        ...
        public ImmutableDictionarySerializerBase(DictionaryRepresentation dictionaryRepresentation, IBsonSerializer<TKey> keySerializer, IBsonSerializer<TValue> valueSerializer)
            : this(
        ...
        public ImmutableDictionarySerializerBase(DictionaryRepresentation dictionaryRepresentation, IBsonSerializerRegistry serializerRegistry)
            : this(
                dictionaryRepresentation,
